...
def problem1(square, thickness, window):
    ...
    circlecen_y = square.center.y + square.length_of_each_side
    line_endx = square.center.x - square.length_of_each_side/2
    square.attach_to(window)
    circle = rg.Circle(rg.Point(square.center.x, circlecen_y), square.length_of_each_side/2)
    circle.fill_color = square.fill_color
    circle.outline_thickness = thickness
    circle.attach_to(window)
    line = rg.Line(circle.center, rg.Point(line_endx, square.center.y))
